# Agentic Integration Builder — Product Requirements

> **Product:** Agentic Integration Builder (AIB). An AI agent that builds healthcare interfaces by chat.
...
**Supersedes:** `docs/PRD.md` (Agentic Integration Builder) and the standalone `PRD_Agentic_Integration_Builder` draft.
