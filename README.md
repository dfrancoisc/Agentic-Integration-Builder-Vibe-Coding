...
Requirements to build from — business driver, use cases, and numbered requirements, written without reference to this implementation: [Integration Spec Questionnaire — Product Requirements](docs/Product_Requirements_Integration_Spec_Questionnaire.md).
...
| [Integration Spec Questionnaire — Product Requirements](docs/Product_Requirements_Integration_Spec_Questionnaire.md) (`.docx`) | **Build from this.** Implementation-neutral requirements for the questionnaire: the business driver and what it costs to get specification wrong, 8 use cases with acceptance criteria, 54 numbered requirements across function, data, integration, security and non-functional, and a hazards section listing the defects this design is known to invite |
| [Integration Spec Questionnaire — Specification](docs/Integration_Spec_Questionnaire_Specification.md) (`.docx`) | The as-built record for this repository: concrete classes, endpoints and framework workarounds. Superseded as the build specification by the document above |
